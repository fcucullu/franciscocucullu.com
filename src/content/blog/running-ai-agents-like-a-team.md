...
The business consequence is leverage, and it is large. The same output that used to require a squad can now come from a few people who direct well, which changes the math on what a team of a given size can deliver. I have seen both ends of this. I have run 24 engineers, and I have also, alone, shipped products used by thousands of people by leaning on exactly this pattern. The lever is not "fewer people doing the same thing." It is the same people, or fewer, carrying far more scope, with the constraint pushed up to how good their judgment is. Output gets cheap. Judgment becomes the thing you are actually paying for, and the thing worth hiring for.
